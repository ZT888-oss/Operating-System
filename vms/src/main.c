...
int main(void) {
    ...
    //for this l2 index, point to l1 page table
    vms_pte_set_ppn(l2_entry, vms_page_to_ppn(l1)); //this L2 entry connect to l1 page table
    ...
    vms_set_root_page_table(l2);//tell MMU where root is, strat from l2 when traslating
